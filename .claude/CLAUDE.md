...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-05 (commit 1a25ae3). Confidence: 99%.
...
- `crates/app/src/watch.rs` — 2 bug fixes, last fix today; 6 commits/90d
- `crates/room/src/watcher.rs` — 2 bug fixes, last fix today; 3 commits/90d
- `crates/room/src/room.rs` — 1 bug fix, last fix today; 4 commits/90d
- `crates/room/tests/two_rooms.rs` — 1 bug fix, last fix today; 3 commits/90d
- `crates/app/src/publish.rs` — 1 bug fix, last fix today; 5 commits/90d

### Code health
Three co-equal signals: defect risk 9.47/10 avg, hotspot health 8.09/10 (stable), worst `crates/app/src/watch.rs` at 5.94/10 · maintainability 9.55/10 · performance risk 0 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
