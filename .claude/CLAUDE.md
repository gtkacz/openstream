...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-06 (commit 6765fd4). Confidence: 99%.
...
- `crates/app/src/ui/members.rs` — 2 bug fixes, last fix today; 3 commits/90d
...
### Code health
Three co-equal signals: defect risk 9.34/10 avg, hotspot health 7.66/10 (stable), worst `crates/app/src/window.rs` at 4.65/10 · maintainability 9.55/10 · performance risk 2 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
