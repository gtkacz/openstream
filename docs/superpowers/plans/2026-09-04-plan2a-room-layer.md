...
- One Conventional Commit per task, imperative subject, no trailers. `cargo fmt --all` and `cargo clippy --workspace --all-targets -- -D warnings` pass before each commit.
