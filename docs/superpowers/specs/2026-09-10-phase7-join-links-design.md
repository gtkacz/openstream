...
- Windows runtime verification remains outstanding. The registry module type-checks and passes clippy for x86_64-pc-windows-msvc in an isolated crate with the declared features; the Windows CI job has not built this branch yet.
